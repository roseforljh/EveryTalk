...
## [1.29.0](https://github.com/roseforljh/EveryTalk/compare/v1.28.1...v1.29.0) (2026-09-20)


### Features

* Cloudflare 支持 MANUAL/SMART/FULL 三档权限模式 ([39650d4](https://github.com/roseforljh/EveryTalk/commit/39650d4dcc9f10ddad83bcfcc94b7a78dc34cb04))
* MCP 未开启时模型可申请启用并经审批恢复执行 ([c70ae02](https://github.com/roseforljh/EveryTalk/commit/c70ae02cb7eeaea1659d350dd0eace3aee7ab5a5))
* OAuth服务接入Gmail与微软邮箱支持并补充邮件网关 ([98894b6](https://github.com/roseforljh/EveryTalk/commit/98894b64fc13bea99d17a5b7e3055d949ec9a852))
* ViewModel与ComputerManager集成Cloudflare管理与接力调度 ([eaaf7cf](https://github.com/roseforljh/EveryTalk/commit/eaaf7cf3d45784927fd71d087289bf41418287e7))
* 升级数据库Schema至v41并支持Cloudflare与临时Worker存储 ([131b2dd](https://github.com/roseforljh/EveryTalk/commit/131b2ddb8545e9f8571e689edbff09313511ca98))
* 合并联网搜索进 MCP 页并支持内置 OAuth 服务登录卡片 ([b76847f](https://github.com/roseforljh/EveryTalk/commit/b76847fcd9c4d439e3ef78c2076fde9fcb4a84fa))
* 完善AgentLoop对接Cloudflare重新授权与资源选择接力流程 ([5f63aef](https://github.com/roseforljh/EveryTalk/commit/5f63aeff9911e99e51960958be385caaa68feded))
* 完善Cloudflare Computer界面交互与Agent接力弹窗 ([b7b5326](https://github.com/roseforljh/EveryTalk/commit/b7b5326cf7921b8590fdcda118b0d8781afbd839))
...
* 实现Cloudflare Computer Provider与just-bash离线沙箱执行核心 ([0d5370b](https://github.com/roseforljh/EveryTalk/commit/0d5370bc6bdca2858f7ab10c90a3b4e71b36d1c7))
* 实现人类接力与待发消息状态管理控制流 ([d34381d](https://github.com/roseforljh/EveryTalk/commit/d34381d52280f157d9619419ba87ea740029b592))
* 手动立即压缩上下文，并修正接力履行与 Secret 写入的失败语义 ([1aee0b1](https://github.com/roseforljh/EveryTalk/commit/1aee0b1c01b81508b8b617a6b8ab8066c5ecc033))
* 接入 GitHub 与 Cloudflare MCP OAuth 登录并补齐工具分页 ([6cd1033](https://github.com/roseforljh/EveryTalk/commit/6cd103321ad9b13d4f3d4c9aa8a46c3815568a09))
...
* 支持HTTPS域名格式的Cloudflare OAuth重定向回调 ([f06ec2d](https://github.com/roseforljh/EveryTalk/commit/f06ec2da64cbd3972ceb668515bb189cf1864967))
...
* 支持邮箱与Notion等MCP服务接入及客户端连接超时优化 ([532008a](https://github.com/roseforljh/EveryTalk/commit/532008ac8da0e0ef58fb7fab3bdaecc54fc1d339))
* 新增 OAuth 回调 Worker 承接 MCP 浏览器登录跳转 ([ee202e0](https://github.com/roseforljh/EveryTalk/commit/ee202e06d4946bba5c18827ce32805236171a562))
...
* 配置javascriptengine依赖、OAuth回调Activity与Workspace文件路径 ([8bfc252](https://github.com/roseforljh/EveryTalk/commit/8bfc2521ccecf707229dc8afb69fd38e9fd2a93f))
* 集成just-bash离线沙箱构建工具链与运行时Assets ([cae7b07](https://github.com/roseforljh/EveryTalk/commit/cae7b0784f43cceaa0b8643eee2f9f7d7c68cb63))


### Bug Fixes

* Agent 审批决定的异常在边界收口 ([db226ca](https://github.com/roseforljh/EveryTalk/commit/db226ca21a643ca47a500bbcf79c4634b5f269a2))
* CI 构建缺少 bun 导致失败 ([db52808](https://github.com/roseforljh/EveryTalk/commit/db5280849559c2e5e4bbb8666725bebe4673c553))
* Cloudflare access token 到期自动续期 ([c454708](https://github.com/roseforljh/EveryTalk/commit/c4547081636ce7a5e89f6f047dc94877786bdbd2))
* Cloudflare Computer 详情页排版与专用图标 ([f947d72](https://github.com/roseforljh/EveryTalk/commit/f947d72a16ee3a69edfbdf4eb2d5d789f2a56e36))
* Cloudflare OAuth 回调改用 oauth.everytalk.cc，并补 refresh_token 续期接口 ([63121e8](https://github.com/roseforljh/EveryTalk/commit/63121e8f0a2210ebf8d7a78ae01b50c34032ffbd))
* Cloudflare scope 名对齐实际返回值，资源索引过期自动重列 ([5f9ff91](https://github.com/roseforljh/EveryTalk/commit/5f9ff9153807cf98e550a068b79c094e002d5805))
* Cloudflare 工具名去掉点号，符合 OpenAI 函数名约束 ([079c5c1](https://github.com/roseforljh/EveryTalk/commit/079c5c11e9718c3d43238309c61ff3cb7e8f57ef))
* Cloudflare 授权过期改走续期，写门与资源未命中处理修正 ([a5afc7b](https://github.com/roseforljh/EveryTalk/commit/a5afc7b3473a319973a1a6391c703c172b0889e8))
* Cloudflare 请求失败透出 API 错误详情，新建 Worker 先建脚本 ([2bebd4f](https://github.com/roseforljh/EveryTalk/commit/2bebd4f24956df56ce7551ddab4866bfc49c918d))
* Cloudflare 重新授权弹窗按钮显示加载态 ([d576add](https://github.com/roseforljh/EveryTalk/commit/d576addc9ac12062f510e40ecc49c7e72aeb939d))
* Release Please 改用工作流内置令牌避免 PAT 过期 ([9095355](https://github.com/roseforljh/EveryTalk/commit/90953557430081665af7dc2fa3ccdce6e940aa19))
* WebFetch 改走 Defuddle Server 解析接口 ([a844925](https://github.com/roseforljh/EveryTalk/commit/a844925dab074676128578e28598d0b2bfc6c93b))
...
* 优化服务器选择面板网格布局与阴影层次 ([b59c0fc](https://github.com/roseforljh/EveryTalk/commit/b59c0fc1445e5fbd4f932dea7d797120c4704be4))
...
* 优化用户气泡内边距与 Markdown 渲染首尾空白 ([2b62960](https://github.com/roseforljh/EveryTalk/commit/2b629609c371380b2948a21069345634fc74e393))
* 优化聊天交互、思考过程展示与UI组件适配 ([54bd56b](https://github.com/roseforljh/EveryTalk/commit/54bd56b76a269b95cb8c704a3027d45e9c7b0148))
* 侧边栏会话删除改为由数据驱动避免动画闪回 ([16c35f0](https://github.com/roseforljh/EveryTalk/commit/16c35f08923dd58d416274d4e167ada590a403e4))
* 修复 Agent 恢复快照反序列化兼容性与审批并发状态落库 ([97bac06](https://github.com/roseforljh/EveryTalk/commit/97bac06175ef11460ab6b5f8da9bbbfce4cb167e))
* 修正受保护 Secret 写入的结果判定与目标路径 ([963877d](https://github.com/roseforljh/EveryTalk/commit/963877d020571b7e3490fc45b4bd5e5b2e8e94c7))
* 修正手动压缩的窗口预算、附件指纹与用量展示 ([f6faf88](https://github.com/roseforljh/EveryTalk/commit/f6faf88c46bf64ff6c500017cfaf1be0a27eff29))
* 停止任务时一并收尾后台受管任务，接力事件不再误判为完成 ([75b00fa](https://github.com/roseforljh/EveryTalk/commit/75b00faf068965dd6ef13a8527848ab55dd94415))
* 删除会话时容忍 Workspace 清理异常避免锁定历史记录 ([33b16f9](https://github.com/roseforljh/EveryTalk/commit/33b16f9bd8946e548f00b021f4769227ff26a75d))
...
* 完善 Agent 审批流恢复状态同步与 MCP 未授权引导提示 ([ef43d73](https://github.com/roseforljh/EveryTalk/commit/ef43d7393a1cff2b18dae86fdd2bc6801adadb12))
...
* 忽略app1目录下的node_modules依赖缓存 ([bd84863](https://github.com/roseforljh/EveryTalk/commit/bd84863036ec9838f113ec74ba3a41b5b635281c))
* 恢复扫描不再把等待接力的调用伪造成 App 退出 ([e4ce8ee](https://github.com/roseforljh/EveryTalk/commit/e4ce8ee2ddf3bb8e6b642a958c6b7ea6bc76d7e5))
* 搜索服务商卡片对齐 MCP 列表样式并补充品牌图标 ([bdc4233](https://github.com/roseforljh/EveryTalk/commit/bdc4233676158971173119eba277ee21134a3d23))
* 支持 Anthropic 网页搜索引用提取并补充流式处理状态指示 ([5c5bae0](https://github.com/roseforljh/EveryTalk/commit/5c5bae04b6f2c6f1e7822d5a1b6e378dbf745265))
...
* 流式 Markdown 重基时越界闪退 ([e8b43f2](https://github.com/roseforljh/EveryTalk/commit/e8b43f27e99891efdf3b3f0a8df78edd2caa8afb))
* 深色与浅色主题补齐容器层级 ([fa1d54e](https://github.com/roseforljh/EveryTalk/commit/fa1d54e209107b30d1ba6c4b8a3e4ea022fbf323))
* 界面细节修正 ([b592421](https://github.com/roseforljh/EveryTalk/commit/b5924218c64011b36c94357c959b881fe0a4e72b))
* 移除 Secret 关键词兜底，改由模型调用安全输入工具 ([f125612](https://github.com/roseforljh/EveryTalk/commit/f125612b255fc9a501e1e99d021dd0d72942150a))
* 移除用户气泡文本视觉偏移并优化气泡布局约束 ([cc161a6](https://github.com/roseforljh/EveryTalk/commit/cc161a655e1a6c0f2799589b243c1dc00ade0334))
* 补充与优化GPT风格矢量图标资源及国际化文本 ([409e96d](https://github.com/roseforljh/EveryTalk/commit/409e96deed3810b9d4bd03409b8f4901ee3c78ca))
* 解耦模型推理思考等级选项与远程规格目录 ([640f000](https://github.com/roseforljh/EveryTalk/commit/640f000e68fd10544cb332e1a72264949391331c))
* 适配深色主题启动闪屏背景与反色滤镜 ([e09318f](https://github.com/roseforljh/EveryTalk/commit/e09318f8bef8fd6af491b55ea0c1de834f1f197e))
* 部署失败可用同一份包安全重试 ([261c86f](https://github.com/roseforljh/EveryTalk/commit/261c86f4627f3c1262473672d961e9e70efb86af))
