...
import io.github.roseforljh.kuntalk.data.DataClass.Message // 假设 Message �?FilteredConversationItem 在这�?
import io.github.roseforljh.kuntalk.ui.screens.MainScreen.drawer.* // 导入抽屉子包下的所有内�?
...
private val LIST_ITEM_MIN_HEIGHT = 48.dp // <--- 控制历史列表项的最小高�?
...
fun AppDrawerContent(
    ...
    var longPressPosition by remember { mutableStateOf<Offset?>(null) } // 长按位置，用于定位弹出菜�?
        ...
        Column(
                        ...
                        LazyColumn(modifier = Modifier.fillMaxSize()) {
                            items(
                                ...
                                Box(
                                    modifier = Modifier
                                        .fillMaxWidth()
                                        .defaultMinSize(minHeight = LIST_ITEM_MIN_HEIGHT) // <--- 应用最小高�?
                                ) {
            ...
            DeleteConfirmationDialog(
                ...
                onConfirm = {
                    ...
                    showDeleteConfirm = false // 关闭对话�?
                    selectedSet.clear()
                    expandedItemIndex = null // 如果有菜单打开，也关闭�?
                    // 从后往前删除，避免索引错位
                    indicesToDelete.sortedDescending().forEach(onDeleteRequest)
                }
            )

            io.github.roseforljh.kuntalk.ui.screens.MainScreen.drawer.ClearAllConfirmationDialog(
                showDialog = showClearAllConfirm,
                onDismiss = { showClearAllConfirm = false },
                onConfirm = {
                    showClearAllConfirm = false // 关闭对话�?
