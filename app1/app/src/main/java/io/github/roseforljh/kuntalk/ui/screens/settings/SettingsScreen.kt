...
import io.github.roseforljh.kuntalk.data.DataClass.ModalityType
...
fun SettingsScreen(
    ...
    if (showAddFullConfigDialog) {
        io.github.roseforljh.kuntalk.ui.screens.settings.AddNewFullConfigDialog(
    ...
    if (showAddModelToKeyDialog) {
        io.github.roseforljh.kuntalk.ui.screens.settings.AddModelToExistingKeyDialog(
    ...
    if (showEditConfigDialog && configToEdit != null) {
        io.github.roseforljh.kuntalk.ui.screens.settings.EditConfigDialog(
    ...
    if (showConfirmDeleteProviderDialog && providerToDelete != null) {
        io.github.roseforljh.kuntalk.ui.screens.settings.ConfirmDeleteDialog(
            onDismissRequest = {
