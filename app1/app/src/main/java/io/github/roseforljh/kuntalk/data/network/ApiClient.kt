package io.github.roseforljh.kuntalk.data.network
            ...
            val multiPartData = MultiPartFormDataContent(
                formData {
                    ...
                    val hasInlineData = chatRequest.messages.any { msg ->
                        (msg as? io.github.roseforljh.kuntalk.data.DataClass.PartsApiMessage)?.parts?.any { part ->
                            part is io.github.roseforljh.kuntalk.data.DataClass.ApiContentPart.InlineData
                        } == true
                    }
                                    ...
                                    try {
                                        ...
                                        if (inputStream != null) {
                                            append(
                                                ...
                                                headers = Headers.build {
                                                    append(HttpHeaders.ContentType, ContentType.parse(finalMimeType))
